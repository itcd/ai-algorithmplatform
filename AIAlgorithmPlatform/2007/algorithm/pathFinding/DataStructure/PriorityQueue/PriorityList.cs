...
namespace DataStructure
{
    ...
    public class PriorityList<T> : IPriorityQueue<T>
    {
        ...
        public PriorityList(IComparer<T> comparator)
        {
            com = comparator;
            list = new List<T>();
        }

        public PriorityList(int initialCapacity, IComparer<T> comparator)
        {
        ...
        public PriorityList(List<T> list, IComparer<T> comparer)
        {
            com = comparer;
            this.list = new List<T>(list);        
        }

        public PriorityList(IPriorityQueue<T> q)
        {
            com = q.getComparator();
            int len = q.getSize();
            list = new List<T>(len);
